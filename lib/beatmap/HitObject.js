...
class Slider extends HitObject {
	...
	render(ctx, ctx2, t, ar, cs) {
		...
		tmpcanvas.width = render[0][0].width * ratio;
		tmpcanvas.height = render[0][0].height * ratio;
		...
		ctx.drawImage(tmpcanvas, rx, ry, tmpcanvas.width, tmpcanvas.height);
		if (false) {
